...
export class Tab3Page {
  ...
  * */
  openDetailsWithState($event, person) {
  ...
  * */
  ...
  /**
  * get the person object and route to new page
  * @param {$event} - field event variable
  * @param {person} - user person data object
  * */
  selectPerson($event, person) {
    ...
    this.router.navigate(['tabs/tab3/detail'], navigationExtras);
